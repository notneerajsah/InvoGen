...
// will fetch the image coming from our server
...
const BusinessProfile = () => {
  ...
  //   fetch user profile if shared previously
  useEffect(() => {
    let mounted = true;
  ...
  // you can remove the preview file by this function
    ...
    <div className={businessProfileStyles.pageContainer}>
      <div className={businessProfileStyles.headerContainer}>
        ...
        {!isSignedIn && (
          ...
          >
            You are not signed in - changes can't be saved. Please sign in to
