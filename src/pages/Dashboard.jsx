...
// const API_BASE = "http://192.168.1.22:4000";
    ...
    <div className={dashboardStyles.pageContainer}>
      <div className={dashboardStyles.headerContainer}>
        ...
        <p className={dashboardStyles.headerSubtitle}>
          Track your invoicing performance and business insights at a glance
        </p>
      </div>
      {/* LOADING ERROR STATE  */}
      {loading ? (
